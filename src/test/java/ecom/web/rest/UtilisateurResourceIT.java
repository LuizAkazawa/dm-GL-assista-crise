...
import static ecom.domain.UtilisateurAsserts.*;
...
import ecom.service.UtilisateurService;
...
class UtilisateurResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "[@b:7-Q.-";
    private static final String UPDATED_EMAIL = "(@li~.VY";
    ...
    public static Utilisateur createEntity() {
        return new Utilisateur().nom(DEFAULT_NOM).prenom(DEFAULT_PRENOM).email(DEFAULT_EMAIL).isBanned(DEFAULT_IS_BANNED);
    }
    ...
    public static Utilisateur createUpdatedEntity() {
        return new Utilisateur().nom(UPDATED_NOM).prenom(UPDATED_PRENOM).email(UPDATED_EMAIL).isBanned(UPDATED_IS_BANNED);
    }
    ...
    void getAllUtilisateurs() throws Exception {
        ...
        restUtilisateurMockMvc
            ...
            .andExpect(jsonPath("$.[*].isBanned").value(hasItem(DEFAULT_IS_BANNED)));
    }
    ...
    void getUtilisateur() throws Exception {
        ...
        restUtilisateurMockMvc
            ...
            .andExpect(jsonPath("$.isBanned").value(DEFAULT_IS_BANNED));
    }
    ...
    void putExistingUtilisateur() throws Exception {
        ...
        updatedUtilisateur.nom(UPDATED_NOM).prenom(UPDATED_PRENOM).email(UPDATED_EMAIL).isBanned(UPDATED_IS_BANNED);
    ...
    void partialUpdateUtilisateurWithPatch() throws Exception {
        ...
        partialUpdatedUtilisateur.nom(UPDATED_NOM).email(UPDATED_EMAIL).isBanned(UPDATED_IS_BANNED);
    ...
    void fullUpdateUtilisateurWithPatch() throws Exception {
        ...
        partialUpdatedUtilisateur.nom(UPDATED_NOM).prenom(UPDATED_PRENOM).email(UPDATED_EMAIL).isBanned(UPDATED_IS_BANNED);
